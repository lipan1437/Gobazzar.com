...
const deletePost =(postID)=>{
  ...
  return (
    <div>
        ...
        <Select placeholder='Select option' onChange={"handleBrandFilter"} id="filterBrand" >
  <option value='option1'>Nokia</option>
  <option value='option2'>Vivo V1</option>
  <option value='option3'>Option 3</option>
</Select>
      {
        function  handleBrandFilter(){
          const selected = document.getElementById("filterBrand").value
          let fiterList = posts.filter(function(el){
            return el.title = selected;
          })
